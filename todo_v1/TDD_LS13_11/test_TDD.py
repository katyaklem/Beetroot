import unittest
import datetime
from TDD import Book
from TDD import Movie
...
class TestBook(unittest.TestCase):
    ...
    def test_book_to_str(self):
        new_book = Book('Dune', '1965, 8, 1', 'Frank Herbert')
    ...
    def test_find_movie_by_book(self):
        ...
        second_movie = Movie('The Social Network', datetime.date(2010, 9, 24), 'David Fincher', second_book)
